import { PilotAccessPage } from "@/components/pilot/creator-pilot-pages";
...
export default async function AccessPage({ params }: { params: Promise<{ projectId: string }> }) {
  ...
  return <PilotWorkspaceShell project={toWorkspaceProject(project)} activeSegment="access"><PilotAccessPage project={project} /></PilotWorkspaceShell>;
}
